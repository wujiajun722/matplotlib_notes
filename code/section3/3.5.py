...
subs_dict = {A:-3,B:0,C:-4,D:0,E:0,F:4}
...
ax.text(0.,0.,'$-3x^2 + 3xy - 4y^2 + 5x + 8y + 4 = 0$',
        bbox={'boxstyle': 'round', 
              'facecolor': 'lightblue',
              'alpha': 0.7,
              'pad': 0.5}
        ,alpha = 0.4)
ax.text(0.,1,f'$y={sp.latex(solutions[0])}$',fontsize = 12)
ax.text(0.,0.8,f'$y={sp.latex(solutions[1])}$',fontsize = 12)
# 文件保存
