\section{隐函数}
	...
	\end{figure}
	\subsection{圆锥曲线和直线}
	\lstinputlisting[language=python]{../code/section3/3.6.py}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{../figures/section3/3.6.png}
		\caption{圆锥曲线和直线}
		\label{fig:example}
	\end{figure}
	\lstinputlisting[language=python]{../code/section3/3.7.py}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{../figures/section3/3.7.png}
		\caption{圆锥曲线和直线}
		\label{fig:example}
	\end{figure}
